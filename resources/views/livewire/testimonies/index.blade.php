<x-layouts.app title="Praise Stories">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <hr class="mb-8 border-yellow-300 dark:border-blue-700">

        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($testimonies as $testimony)
                @if ($loop->index === 3)
                    <!-- Premium CTA Card -->
                    <div class="rounded-lg border border-blue-950 dark:border-yellow-200 bg-blue-950 text-white dark:bg-yellow-50 dark:text-black p-6 shadow-lg text-center col-span-1 sm:col-span-2 lg:col-span-3">
                        ...
                        class="inline-block bg-yellow-50 text-black dark:bg-blue-950 dark:text-white font-semibold text-sm px-5 py-2 rounded-md transition hover:opacity-90">
                            Learn More & Upgrade
                        </a>
                    </div>
                @endif
                ...
                <!-- Testimony Card -->
                <div class="rounded-lg border border-yellow-200 dark:border-blue-700 p-6 shadow-sm bg-yellow-50 dark:bg-blue-950">
