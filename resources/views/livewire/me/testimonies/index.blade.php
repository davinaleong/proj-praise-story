<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <header class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('me.testimonies.create') }}"
            class="inline-flex items-center gap-2 bg-black text-white dark:bg-white dark:text-black font-semibold text-sm px-4 py-2 rounded-md transition hover:opacity-90">
