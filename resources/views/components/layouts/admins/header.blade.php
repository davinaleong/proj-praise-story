...
<body class="min-h-screen bg-rose-200 dark:bg-rose-800">
    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            <flux:navbar.item icon="layout-grid" :href="route('admins.dashboard')" :current="request()->routeIs('admins.dashboard')" wire:navigate>
                {{ __('Dashboard') }}
            </flux:navbar.item>
        </flux:navbar>
        ...
        <flux:dropdown position="top" align="end">
            <flux:profile class="cursor-pointer" :initials="$admin?->initials" />
